...
date: 11/08/2025
purpose: static file for Project 2 App
---

## Prepare for Analysis
```{r}

library(cdlTools)  # for converting State to FIPS Code
library(gt) #for making formatted contingency tables  
library(janitor) #for cleaning up data and tables
library(readxl) # for reading in MS Excel files
library(tidyverse) # for making data manipulation, visualization, and analysis easier and more consistent by using a unified grammar and data structures
library(tigris) #for generating the Chloropeth Map
library(zipcodeR) # for working with zipcodes
...
#RDS is the data source for Project 2 App
